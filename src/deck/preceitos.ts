...
export const preceitos: Preceito[] = [
    ...
    { num: '23', title: `Ninguém fiscaliza o trabalho individual dos voluntários. Existe a confiança que cada um esteja fazendo o melhor durante a relação de ajuda.` },

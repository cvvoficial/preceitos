export function GiftImage({className}:{className: string}) {
    const color1 = "#4d4d4d"
    const color2 = "#fff"
    const color3 = "#b3b3b3"
    const color4 = "#7f7f7f"
    ...
    const color8 = "#e6e6e6"
    const color9 = "#666"
    const color10 = "#191919"
    const fill1 = "#0097ac"
    return <svg className={className} viewBox="0 0 668.13 692.11" version="1.0">
        <defs id="defs5522">
            ...
            <linearGradient id="linearGradient3969">
                <stop id="stop3971" stop-color={color1} offset="0" />
                <stop id="stop3973" stop-color={color1} stop-opacity="0" offset="1" />
            </linearGradient>
            ...
            <linearGradient id="linearGradient4224">
                <stop id="stop4226" stop-color={color2} offset="0" />
                <stop id="stop4228" stop-color={color1} stop-opacity="0" offset="1" />
            </linearGradient>
            ...
            <linearGradient id="linearGradient3892">
                <stop id="stop3894" stop-color={color2} offset="0" />
                <stop id="stop3896" stop-color={color2} stop-opacity="0" offset="1" />
            </linearGradient>
            ...
            <radialGradient id="radialGradient2650" gradientUnits="userSpaceOnUse" cy="238.35" cx="985.76" gradientTransform="matrix(1.1641 -1.9754 2.046 1.2058 -614.23 1863.9)" r="11.035">
                <stop id="stop4027" stop-color={color2} offset="0" />
                <stop id="stop4029" stop-color={color2} stop-opacity="0" offset="1" />
            </radialGradient>
            <linearGradient id="linearGradient2652" x1="1002.9" gradientUnits="userSpaceOnUse" x2="1002.9" y1="233.49" y2="218.97" />
            <linearGradient id="linearGradient2654" x1="991.58" gradientUnits="userSpaceOnUse" y1="219.12" gradientTransform="translate(16.514 -35.636)" x2="992.39" y2="214.7" />
            <linearGradient id="linearGradient2656" x1="1002.8" gradientUnits="userSpaceOnUse" y1="215.93" gradientTransform="translate(16.514 -35.636)" x2="1003.1" y2="223.38" />
            <linearGradient id="linearGradient2660" x1="991.58" gradientUnits="userSpaceOnUse" y1="219.12" gradientTransform="translate(30.258 -36.49)" x2="992.39" y2="214.7" />
            <linearGradient id="linearGradient2666" x1="991.1" gradientUnits="userSpaceOnUse" y1="208.36" gradientTransform="translate(16.514 -35.636)" x2="991.1" y2="220.49" />
            <linearGradient id="linearGradient2670" x1="991.1" gradientUnits="userSpaceOnUse" y1="208.36" gradientTransform="translate(22.384 -.58596)" x2="991.1" y2="220.49" />
            <linearGradient id="linearGradient2672" x1="999.14" gradientUnits="userSpaceOnUse" y1="206.81" gradientTransform="translate(17.482 -35.69)" x2="1003" y2="213.36">
                <stop id="stop4364" stop-color={color3} offset="0" />
                <stop id="stop4366" stop-color={color2} offset="1" />
            </linearGradient>
            <linearGradient id="linearGradient2674" y2="164.62" gradientUnits="userSpaceOnUse" y1="170.13" x2="1006.1" x1="1006.7">
                <stop id="stop5135" stop-color={color4} stop-opacity="0" offset="0" />
            ...
            <linearGradient id="linearGradient2680" y2="165.69" gradientUnits="userSpaceOnUse" y1="170.63" x2="1013" x1="1015.5">
                <stop id="stop4893" stop-color={color5} offset="0" />
                <stop id="stop4895" stop-color={color2} stop-opacity="0" offset="1" />
            </linearGradient>
            ...
            <linearGradient id="linearGradient2688" y2="174.3" gradientUnits="userSpaceOnUse" y1="166.91" x2="1017.1" x1="1027.7">
                <stop id="stop4817" stop-color={color5} offset="0" />
                <stop id="stop4819" stop-color={color6} offset="1" />
            </linearGradient>
            <linearGradient id="linearGradient2690" y2="174.4" gradientUnits="userSpaceOnUse" y1="164.83" x2="1025.1" x1="1036.5">
                <stop id="stop4809" stop-color={color6} offset="0" />
                <stop id="stop4811" stop-color={color2} offset="1" />
            </linearGradient>
            <linearGradient id="linearGradient2692" x1="1004.5" gradientUnits="userSpaceOnUse" x2="1008.6" y1="162.97" y2="162.04" />
            <linearGradient id="linearGradient2694" x1="1006.5" gradientUnits="userSpaceOnUse" y1="161.72" gradientTransform="translate(22.425 .71760)" x2="1008.2" y2="163.86" />
            <linearGradient id="linearGradient2696" y2="171.9" gradientUnits="userSpaceOnUse" y1="164.11" x2="1032.4" x1="1031.8">
                <stop id="stop5295" stop-color={color2} offset="0" />
                <stop id="stop5297" stop-color={color2} stop-opacity="0" offset="1" />
            </linearGradient>
            <linearGradient id="linearGradient2706" x1="1020.7" gradientUnits="userSpaceOnUse" y1="173.07" gradientTransform="matrix(15.815 0 0 15.815 -15731 -2436.6)" x2="1027" y2="173.07">
                <stop id="stop5399" stop-color={color6} offset="0" />
                <stop id="stop5401" stop-color={color10} offset="1" />
            </linearGradient>
            <radialGradient id="radialGradient2709" gradientUnits="userSpaceOnUse" cy="205.93" cx="999.93" gradientTransform="matrix(55.986 25.92 -51.367 110.96 -45063 -48503)" r="2.8655">
                <stop id="stop4803" stop-color={color2} offset="0" />
            ...
            <linearGradient id="linearGradient2714" x1="1012.3" gradientUnits="userSpaceOnUse" y1="172.48" gradientTransform="matrix(15.815 0 0 15.815 -15731 -2436.6)" x2="1006.7" y2="174.09">
                <stop id="stop2957" stop-color={color3} offset="0" />
                <stop id="stop2959" stop-color={color2} offset="1" />
            </linearGradient>
            <radialGradient id="radialGradient2717" gradientUnits="userSpaceOnUse" cy="209.14" cx="990.44" gradientTransform="matrix(-28.792 -35.184 33.772 -27.637 21787 40907)" r="5.838">
                <stop id="stop4206" stop-color={color2} offset="0" />
                <stop id="stop4208" stop-color={color3} offset="1" />
            </radialGradient>
            ...
            <radialGradient id="radialGradient2730" gradientUnits="userSpaceOnUse" cy="164.89" cx="1006.3" gradientTransform="matrix(15.657 27.812 -42.83 24.111 -8504.3 -31809)" r="5.4729">
                <stop id="stop4825" stop-color={color5} offset="0" />
                <stop id="stop4827" stop-color={color7} offset="1" />
            </radialGradient>
            <linearGradient id="linearGradient2733" x1="1007.9" gradientUnits="userSpaceOnUse" y1="210.21" gradientTransform="matrix(15.815 0 0 15.815 -15470 -3000.2)" x2="1020" y2="235.48">
                <stop id="stop4306" stop-color={color8} offset="0" />
                <stop id="stop4308" stop-color={color9} offset="1" />
            </linearGradient>
            <linearGradient id="linearGradient2738" x1="994.01" gradientUnits="userSpaceOnUse" y1="235.88" gradientTransform="matrix(15.815 0 0 15.815 -15470 -3000.2)" x2="996.02" y2="216.38">
                <stop id="stop3960" stop-color={color2} offset="0" />
                <stop id="stop3962" stop-color={color8} offset="1" />
            </linearGradient>
        </defs>
        <g id="layer1" transform="translate(-20.219 -117.73)">
            ...
            <path id="path3105" fill-rule="evenodd" fill={fill1} d="m38.852 368.18v277.03l354.81 128.85 273.95-183.15v-263.18l-281.65 149.29-347.11-108.84z" />
            ...
            <path id="path3111" fill={fill1} d="m319.5 219.77l355.65 56.07-0.87 95.52-279.89 141.64-360.74-110.9 0.584-97.65 285.27-84.68z" />
